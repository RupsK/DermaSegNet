...
# Get the image
# =============================================================================
#C:/Users/rupal/OneDrive/Desktop/try2
#Getting all the images in the folder
for im in glob('C:/Users/rupal/OneDrive/Desktop/try/*.jpg'):
     img = cv2.imread(im,-1)
     # change size new_image = image.resize((224, 224))
...
# define criteria, number of clusters(K) and apply kmeans()
     ...
     K = 8
     ret,label,center=cv2.kmeans(Z,K,criteria,None,10,cv2.KMEANS_RANDOM_CENTERS)
...
# Now convert back into uint8, and make original image
     ...
     #cv2.waitKey(0)
     output_path = 'C:/Users/rupal/OneDrive/Desktop/try' #Give path where you want to save the kmeans images
...
# =============================================================================
     ...
     output_path = 'C:/Users/rupal/OneDrive/Desktop/try' # Give the path where you want to save HSV images
     ...
     output_path = 'C:/Users/rupal/OneDrive/Desktop/try' # Destination folder for save Enhances HSV images
     ...
     output_path = 'C:/Users/rupal/OneDrive/Desktop/try' # Destination folder for save Enhances BGR images
...
# =============================================================================
     ...
     output_path = 'C:/Users/rupal/OneDrive/Desktop/try'
...
# wherever it is marked black (sure background), change mask=0
        ...
        mask[newmask == 255] = 1
        rect1 = (5,5,220,220)
        dim= cv2.grabCut(img,mask,rect1,bgdModel,fgdModel,5,cv2.GC_INIT_WITH_RECT)
...
# =============================================================================
        ...
        cv2.grabCut(Enhance_img,mask,rect,bgdModel,fgdModel,5,cv2.GC_INIT_WITH_RECT)
        mask2 = np.where((mask==2)|(mask==0),0,1).astype('uint8')
        GrabCut_img= img*mask2[:,:,np.newaxis]
...
# wherever it is marked black (sure background), change mask=0
        ...
        mask[newmask == 255] = 1
        rec2 = (5,5,220,220)
        dim2= cv2.grabCut(lab,mask,rec2,bgdModel,fgdModel,5,cv2.GC_INIT_WITH_RECT)
        mask2 = np.where((mask==2)|(mask==0),0,1).astype('uint8')
...
# =============================================================================
     ...
     output_path = 'C:/Users/rupal/OneDrive/Desktop/Combine23Class/trash'
